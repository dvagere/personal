...
const IconStackOverflow = () => (
  ...
  >
    ...
    <path d="m2 15.429v8.571h18.992v-8.571h-2.113v6.428h-14.766v-6.428z" fill="#a8b2d1"/>
    <path d="m10.453 5.063 8.109 6.873 1.346-1.65-8.109-6.873z" fill="#a8b2d1"/>
    <path d="m22 8.587-6.302-8.587-1.691 1.286 6.302 8.587z" fill="#a8b2d1"/>
  </svg>
);
